...
Chỉ Admin role `ADMIN` mới được truy cập endpoint xóa qua JWT middleware.
...
- Các endpoint GET/POST review/comment vẫn public theo scope portal MVP.
